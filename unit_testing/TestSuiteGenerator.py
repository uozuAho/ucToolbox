...
def generateOutputSource(sources):
    ...
    ofile.write("using namespace ucToolbox::unitTests;\n\n")
...
def generateOutputHeader(sources):
    ...
    for source in sources:
        ofile.write("extern const ucToolbox::unitTests::TestSuite " + 
                    genTestSuiteName(source) + ";\n")
    ofile.write("\n")
    
    num_suites = len(sources)
    ofile.write("#define TOTAL_SUITES    " + str(num_suites) + "\n\n")
    ofile.write("extern const ucToolbox::unitTests::TestSuite all_suites[TOTAL_SUITES];\n\n")
...
def getAllTestSuitesStruct(source_files):
    ...
    output = "const ucToolbox::unitTests::TestSuite all_suites[TOTAL_SUITES] = {\n"
