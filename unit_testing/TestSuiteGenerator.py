...
def main():
    sources, headers = getSourceAndHeaderFiles(UNIT_TESTS_LOCATION)
...
# returns lists of source and header files found within
# the specified path. Note that the returned lists
# contain relative path names
def getSourceAndHeaderFiles(path):
    ...
    for item in os.listdir(path):
        ...
        elif isHeaderFile(relpath):
            headers.append(relpath)
